...
SEXP time_yday(SEXP x) {
  ...
  case timerip_class_date: return date_time_yday(x);
  case timerip_class_posixct: return posixct_time_yday(x);
  case timerip_class_posixlt: return posixlt_time_yday(x);
