...
SEXP time_mday(SEXP x) {
  ...
  case timerip_class_date: return date_time_mday(x);
  case timerip_class_posixct: return posixct_time_mday(x);
  case timerip_class_posixlt: return posixlt_time_mday(x);
