...
SEXP time_second(SEXP x) {
  ...
  case timewarp_class_date: return date_time_second(x);
  case timewarp_class_posixct: return posixct_time_second(x);
  case timewarp_class_posixlt: return posixlt_time_second(x);
